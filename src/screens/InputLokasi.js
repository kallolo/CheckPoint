      ...
      <Swipeable
        renderRightActions={(progress, dragX) => {
          ...
          return (
            <>
              <TouchableOpacity
                onPress={() => removeLocation(item.location)}
        ...
        <List.Item
          ...
          left={(props) => (
            <List.Icon {...props} icon="map-marker-radius" color="green" />
          )}
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        <View>
          ...
          <Button
            ...
            icon="check"
            mode="contained"
            onPress={() => saveLocation(lokasi, longitude, latitude)}>
            Simpan
          </Button>
        </View>
